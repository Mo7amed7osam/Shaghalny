      ...
      <div className="shrink-0 border-t border-ink-100 p-3 dark:border-ink-dark-border">
        <div className="flex items-center gap-3 rounded-lg p-2">
          ...
          <div className="flex shrink-0 gap-1">
            <button
              onClick={toggleTheme}
              className="flex h-7 w-7 items-center justify-center rounded-md text-ink-400 transition-colors hover:bg-ink-100 hover:text-ink-700 dark:hover:bg-white/10 dark:hover:text-white"
